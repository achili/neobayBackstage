			...
			<nav>
				<ul class="pagination mt20 mb0">
					...
					<li v-show="!isFirstPage">
						<a class="clear-focus" href="javascript:void(0)" @click.stop.prevent="changePage(0)">&laquo;</a>
					</li>
					<li v-show="!isFirstPage">
						<a class="clear-focus" href="javascript:void(0)" @click.stop.prevent="changePage(pager.page-1)">&lsaquo;</a>
					</li>

					<li v-for="indicator in indicators" :class="{active: indicator === pager.page+1}">
						<a class="clear-focus" href="javascript:void(0)" @click.stop.prevent="changePage(indicator-1)">{{indicator}}</a>
					</li>

					<li v-show="!isLastPage">
						<a class="clear-focus" href="javascript:void(0)" @click.stop.prevent="changePage(pager.page+1)">&rsaquo;</a>
					</li>
					<li v-show="!isLastPage">
						<a class="clear-focus" href="javascript:void(0)" @click.stop.prevent="changePage(totalPages-1)">&raquo;</a>
					</li>
				</ul>
			</nav>
...
<script>
	...
	export default {
      ...
      "pager"(newVal, oldVal){
        ...
        newVal.offset = parseInt(newVal.offset);
      },
			//场外的改变，我们只做调整，但是不刷新。
