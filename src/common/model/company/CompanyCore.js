...
CompanyCore.prototype = new BaseEntity();
CompanyCore.prototype.constructor = CompanyCore;

//测试数据。
CompanyCore.prototype.mockData = function () {
  this.name = "小川威慑";
  this.department = "外交部";
  this.position = "部长";
...
CompanyCore.prototype.render = function (obj) {
...
CompanyCore.prototype.getForm = function () {
