...
export default function Torch2018() {
  ...
  if(Vue.store.state.debug) {
    ...
    this.businessEntryTime = new Date();
    //5 行业类别
    this.industryCategory = "A010110111";
    //6 企业登记注册类型
    this.registrationType = "110";
    //7 企业所属技术领域
...
Torch2018.prototype = new BaseEntity();
Torch2018.prototype.constructor = Torch2018;

Torch2018.prototype.getFilters = function () {
  return [
...
Torch2018.prototype.getForm = function () {
  let form = {
    ...
    technologyScience: this.technologyScience,
    ...
    inventionNumber: this.inventionNumber,
...
Torch2018.prototype.render = function (obj) {
...
Torch2018.prototype.validate = function () {
  //    1  企业名称
...
Torch2018.prototype.httpDetailByProject = function (projectId, successCallback, failureCallback) {
  let that = this;
  this.httpPost("/torch2018/detail/by/project", {projectId: projectId}, function (response) {
