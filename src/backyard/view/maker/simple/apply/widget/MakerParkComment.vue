  ...
  <NbSlidePanel type="info">
    ...
    <div slot="body">
      <div class="col-xs-12" >
        ...
        <div class="row mt10" v-show="makerPark.errorMessage">
  ...
  export default{
    ...
    methods: {
      ...
      submit() {
        ...
        this.makerPark.httpAssess(this.service, this.comment, function () {
      ...
      refresh(){
        ...
        if (this.makerPark.id) {
          this.pager.setFilter("makerSimpleApplyId",this.makerPark.id);
