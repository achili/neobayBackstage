<template>
  <div class="animated fadeIn">
    ...
    <div class="row mb10">
      <div class="col-xs-12 clearfix">
        ...
        <div class="pull-right">
          <button class="btn btn-primary" @click.stop.prevent="$router.push('/by/torch2018/create')">
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        <div v-for="torch in pager.torch2018s" class="bg-white p10 mt10 cursor br4"
             @click.stop.prevent="$router.push('/by/torch2018/detail/' + torch.id)">
